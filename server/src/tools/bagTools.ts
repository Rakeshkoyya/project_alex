...
export function searchBagTool(ctx: RoleContext) {
  return tool(
    "search_bag",
    "Search student bag",
...
export function listBagTool(ctx: RoleContext) {
  return tool("list_bag", "List student bag", "List the resources, notes and points to remember in the student's bag.", Type.Object({}), () => {
...
export function addNoteTool(ctx: RoleContext, author: "librarian" | "tutor" | "advisor") {
  return tool(
    "add_note",
    "Write note to bag",
...
export function addKeyPointTool(ctx: RoleContext, role: "librarian" | "tutor") {
  return tool(
    "add_key_point",
